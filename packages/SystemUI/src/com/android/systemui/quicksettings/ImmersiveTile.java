    ...
    public ImmersiveTile(Context context, 
        ...
        mOnClick = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Settings.System.putIntForUser(mContext.getContentResolver(), Settings.System.IMMERSIVE_MODE,
                        mEnabled ? 0 : 1, UserHandle.USER_CURRENT);
            }
        };

        Uri stateUri = Settings.System.getUriFor(Settings.System.IMMERSIVE_MODE);
